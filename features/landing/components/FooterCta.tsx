  ...
  return (
    <div className="relative overflow-hidden border-b border-black/[0.06] bg-[#fbfbfa]">
      ...
      <div className="relative mx-auto max-w-3xl px-6 py-20 text-center sm:py-24">
        ...
        <p className="mx-auto mt-5 max-w-xl text-[16px] leading-relaxed text-[#6b6b6b]">
          Run a free GEO audit, track citations across models, and ship fixes that move how ChatGPT,
          Perplexity, and Gemini talk about you.
        </p>
        <Link
          href="/sign-up"
