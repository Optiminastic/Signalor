...
export function LandingFaq({
  ...
  return (
    <section
      id={sectionId}
      className="relative border-t border-black/8 bg-muted px-6 py-20 sm:py-24 lg:px-12"
              ...
              <li key={item.question} className="border-b border-black/10">
                ...
                >
                  <div className="min-h-0 overflow-hidden">
                    <p className="pb-5 pr-10 text-sm leading-relaxed text-muted-foreground sm:text-sm sm:leading-relaxed">
                      {item.answer}
                    </p>
                  </div>
                </div>
