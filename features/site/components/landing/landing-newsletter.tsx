...
import { Check, Mail } from "@/features/site/components/icons";
      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-12">
        <div className="flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center">
          ...
          <div className="flex min-w-0 items-start gap-4">
            <span className="hidden h-11 w-11 shrink-0 items-center justify-center rounded-none bg-primary text-primary-foreground shadow-[0_6px_16px_-6px_rgba(224,74,61,0.6)] sm:flex">
