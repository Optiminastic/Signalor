...
type LogoCompProps = {
  size?: number;
  /** Smaller wordmark + icon for auth / nav density */
  compact?: boolean;
  /** Disable mark animation (e.g. auth) */
  animated?: boolean;
  className?: string;
};
