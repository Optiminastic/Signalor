        ...
        {step === "email" ? (
          <form onSubmit={handleSendOtp} className="space-y-3">
            <div className="space-y-1.5">
              <Label htmlFor="creator-email" className="text-xs font-medium text-foreground">
                Email
              </Label>
              <Input
                id="creator-email"
          ...
          <form onSubmit={handleVerify} className="space-y-3">
            <div className="space-y-1.5">
              <Label className="text-xs font-medium text-foreground">Enter the 6-digit code</Label>
