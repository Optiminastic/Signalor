...
import { Check, ChevronDown, Search } from "@/features/site/components/icons";
import type { AudienceSize, SocialEntry } from "@/features/site/lib/api/partners-program";
          ...
          <div className="border-b border-border px-3 py-2">
            <div className="relative">
              ...
              <input
                ...
                className="w-full rounded border border-border bg-background py-1.5 pl-7 pr-2 text-xs focus:outline-none"
              />
            </div>
          </div>
