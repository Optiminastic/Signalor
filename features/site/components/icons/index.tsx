 ...
 * `import { Foo } from "@/features/site/components/icons"` works unchanged.
 *
...
export const Cloud: LucideIcon = (p) => (
  <svg {...base(p)}>
    <path d="M17.5 19a4.5 4.5 0 1 0-1.41-8.775 5.5 5.5 0 0 0-10.595 2.626A4.5 4.5 0 0 0 6.5 19z" />
    {dot(12, 14)}
  </svg>
);
...
export const Crown: LucideIcon = (p) => (
  <svg {...base(p)}>
    <path d="M11.562 3.266a.5.5 0 0 1 .876 0L15.39 8.87a1 1 0 0 0 1.516.294L21.45 5.43A1 1 0 0 1 23 6.353V16a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V6.353a1 1 0 0 1 1.55-.923l4.543 3.733a1 1 0 0 0 1.516-.295z" />
    <path d="M5 21h14" />
    {dot(12, 12)}
  </svg>
);
...
export const Github: LucideIcon = (p) => (
  <svg {...base(p)}>
    <path d="M15 22v-4a4.8 4.8 0 0 0-1-3.5c3 0 6-2 6-5.5.08-1.25-.27-2.48-1-3.5.28-1.15.28-2.35 0-3.5 0 0-1 0-3 1.5-2.64-.5-5.36-.5-8 0C6 2 5 2 5 2c-.3 1.15-.3 2.35 0 3.5A5.4 5.4 0 0 0 4 9c0 3.5 3 5.5 6 5.5-.39.49-.68 1.05-.85 1.65S8.93 17.42 9 18v4" />
...
export const Home: LucideIcon = (p) => (
  <svg {...base(p)}>
    <path d="M3 9.5 12 2l9 7.5V21a2 2 0 0 1-2 2h-4a1 1 0 0 1-1-1v-6a1 1 0 0 0-1-1h-2a1 1 0 0 0-1 1v6a1 1 0 0 1-1 1H5a2 2 0 0 1-2-2z" />
    {dot(12, 14)}
  </svg>
);
...
export const Sparkle: LucideIcon = (p) => (
  <svg {...base(p)}>
    <path d="M12 3a4 4 0 0 0 4 4 4 4 0 0 0-4 4 4 4 0 0 0-4-4 4 4 0 0 0 4-4z" />
    <path d="M19 13v3" />
    <path d="M21 14.5h-4" />
    {dot(12, 7)}
  </svg>
...
export const Triangle: LucideIcon = (p) => (
  <svg {...base(p)}>
    <path d="M13.73 4a2 2 0 0 0-3.46 0L2.32 18a2 2 0 0 0 1.73 3h15.9a2 2 0 0 0 1.73-3L13.73 4z" />
    {dot(12, 14)}
  </svg>
);
