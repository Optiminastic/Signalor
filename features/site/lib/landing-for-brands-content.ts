...
export const FOR_BRANDS_FAQ = [
  ...
  {
    question: 'Which AI engines does Signalor track for my brand?',
    answer:
      'Signalor tracks brand presence and citations across ChatGPT (OpenAI), Claude (Anthropic), Gemini (Google), Perplexity, Google AI Overviews, and Microsoft Copilot. Engine coverage varies by plan.',
  },
  {
  ...
  {
    question: 'Can Signalor apply fixes for me?',
    answer:
