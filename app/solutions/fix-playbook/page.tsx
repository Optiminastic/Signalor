        ...
        {recs.map((r) => (
          ...
          >
            <div className="flex items-center gap-2">
              <span
                className={`rounded-none px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide ${r.sevTone}`}
              >
                {r.severity}
              </span>
              <span className="text-[11px] font-semibold text-success">{r.impact}</span>
            </div>
