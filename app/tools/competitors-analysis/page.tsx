  ...
  return (
    <MarketingShell>
      <p className="sr-only">
        ...
        often in active purchase-decision queries. This AI competitor analysis goes beyond
        traditional backlink or keyword ranking tools: it maps the competitive landscape as
        generative engines like ChatGPT, Gemini, Perplexity, and Claude see it. Free, no sign-up
        required for the co-mention ranking. Upgrading adds per-engine AI citation breakdowns that
        show which competitors win on ChatGPT vs Gemini vs Perplexity, and the specific prompts
