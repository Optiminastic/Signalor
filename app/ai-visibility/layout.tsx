...
const aiVisibilityWebPageJsonLd = {
  ...
  mainEntity: {
    ...
    featureList: [
      'Schema.org coverage audit across key templates',
      'E-E-A-T scoring for authorship, citations, and credibility markers',
      'Per-engine AI visibility breakdown (ChatGPT, Claude, Gemini, Perplexity, Google, Bing)',
